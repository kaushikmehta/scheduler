...
describe("Form", () => {
  ...
  it("can successfully save after trying to submit an empty student name", () => {
    ...
    // Form Component has validation on an interviewer being selected
    // As a result, this test has been slightly modified to account for it
    // Passing in interviewer id as opposed to null on last expect
